...
INSERT INTO `ky_crontab` VALUES (1,'{\"url\":\"admin\\/Check\",\"layer\":\"index\",\"vars\":\"\"}',86400,1,unix_timestamp(now()),unix_timestamp(now()),unix_timestamp(now()),0,2,NULL,'admin/Check');
